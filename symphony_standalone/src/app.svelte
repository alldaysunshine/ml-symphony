<script lang="ts">
  ...
  import StandalonePage from '../../symphony_ui/src/StandalonePage.svelte';
  import Toolbar from '../../symphony_ui/src/toolbar/Toolbar.svelte';

  export let components: Record<string, typeof SvelteComponent>;

  const URL_PARAMS = new URLSearchParams(window.location.search);

  export let widgetInfo: WidgetInfo | undefined = undefined;
  let loading = false;
